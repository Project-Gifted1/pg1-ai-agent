...
function getAudioContext() {
    if (!audioCtx) {
        ...
        if (AudioContextClass) {
            ...
            // Build DynamicsCompressor to guarantee crisp high-fidelity normalized output
...
function speakAgentResponse(text, forceSpeak = false) {
    ...
    try {
        // Ensure dictation mic is released to prevent sample-rate drop & audio ducking
...
function initNeuralAudioVisualizer() {
    ...
    function renderVisualizerFrame() {
        ...
        for (let i = 0; i < numBars; i++) {
            ...
            if (isSpeakingNow) {
                // Harmonic pulsating multi-frequency agent voice spectrum
                ...
                // Glowing crimson/amber microphone input modulation
                ...
                // Ambient sovereign idle telemetry shimmer
