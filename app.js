...
function saveSessions() { localStorage.setItem('pg1_sessions', JSON.stringify(sessions)); }
...
async function sendCommand() {
    ...
    try {
        ...
        let agentReply = null;
        try { agentReply = JSON.parse(rawText).response; } catch { agentReply = rawText; }
...
function handleKeyPress(e) { if (e.key === 'Enter') sendCommand(); }
